...
# 第一种方式呢，是先生成了一个画布，然后在这个画布上隐式的生成一个画图区域来进行画图
# 第二种方式，先生成一个画布，然后，我们在此画布上，选定一个子区域画了一个子图
...
ax.set_yticklabels(["50kg", "60kg", "70kg", "80kg", "90kg", "100kg"], color='m')
...
ax.set_ylabel("销售量", fontsize=15, fontweight='light')  # 添加y轴标签，设置字体大小为16，这里也可以设字体样式与颜色
