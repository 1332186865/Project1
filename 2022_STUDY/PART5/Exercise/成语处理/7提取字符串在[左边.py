...
class Finding:
    def __init__(self):
        ...
        self.str_dir = r"data/100心理 字符串.txt"
        self.docx_dir = r"data/100语料.txt"
        self.output_dir = r"data/100心理 目标 片段.txt"
