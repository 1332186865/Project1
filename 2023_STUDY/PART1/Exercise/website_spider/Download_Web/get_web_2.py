...
class Spider:
    ...
    def __init__(self):
        self.headers = {
                ...
                "Cookie": "MDPsid=3904fd7653f162ef4ac03264b86f162a; STICKY=s148; HT-cookie-banner-seen=true; HT-tracking-cookie-consent=false; HT-marketing-cookie-consent=false; HT-preferences-cookie-consent=false",
    ...
    def log(self):
        ...
        fh = logging.FileHandler("log_2.log", mode='a', encoding="UTF-8")
