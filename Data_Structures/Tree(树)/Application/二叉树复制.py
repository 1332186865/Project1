...
def CopyBTree1(bt1: BTree):  # 基于先序遍历复制二叉树
    bt2 = BTree()
    bt2.set_root(_CopyBTree1(bt1.b))
    return bt2
...
def CopyBTree2(bt1: BTree):  # 基于后序遍历复制二叉树
    bt2 = BTree()
    bt2.set_root(_CopyBTree2(bt1.b))
    return bt2
...
bt2 = CopyBTree1(bt)
print("bt2:", end=' ')
print(bt2.disp_b_tree())
print("bt->bt3")
bt3 = CopyBTree2(bt)
print("bt3:", end=' ')
print(bt3.disp_b_tree())
