...
let userID = '345dc073-3340-4e28-a745-a7725b40b3da';
            ...
            if (!upgradeHeader || upgradeHeader !== 'websocket') {
                ...
                switch (url.pathname) {
                    ...
                    default:
                        ...
                        newHeaders.set('referer', 'https://www.google.com/search?q=Genshin');
...
// https://github.com/zizifn/excalidraw-backup/blob/main/v3ray-protocol.excalidraw
...
<a href='https://github.com/3Kmfi6HP/Genshin' target='_blank'>Genshin - https://github.com/3Kmfi6HP/Genshin</a>
...
<a href='v3rayng://install-config?url=${encodeURIComponent(subbestip)}' target='_blank'>v3rayNG优选IP自动</a></p>`;

    // HTML Head with CSS and FontAwesome library
    const htmlHead = `
  <head>
	<title>Genshin: วเลส configuration</title>
	<meta name='description' content='This is a tool for generating วเลส protocol configurations. Give us a star on GitHub https://github.com/3Kmfi6HP/Genshin if you found it useful!'>
	<meta name='keywords' content='Genshin, cloudflare pages, cloudflare worker, severless'>
	<meta name='viewport' content='width=device-width, initial-scale=1'>
	<meta property='og:site_name' content='Genshin: วเลส configuration' />
	<meta property='og:type' content='website' />
	<meta property='og:title' content='Genshin - วเลส configuration and subscribe output' />
	...
	<meta name='twitter:title' content='Genshin - วเลส configuration and subscribe output' />
